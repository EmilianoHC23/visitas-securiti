            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                    <div className="border-b border-gray-100 bg-gray-50/50">
                        <nav className="flex -mb-px overflow-x-auto sm:overflow-x-visible min-w-max sm:min-w-0">
                            <button
                                onClick={() => setActiveTab('account')}
                                className={`flex-1 px-3 sm:px-6 py-3 sm:py-5 text-xs sm:text-base font-semibold border-b-3 transition-all whitespace-nowrap ${
                                    activeTab === 'account'
                            ...
                            >
                                <div className="flex items-center justify-center gap-1 sm:gap-2">
                                    <Building2 className="w-5 h-5 sm:w-4 sm:h-4 flex-shrink-0" />
                    ...
                    <div className="p-6 sm:p-8 lg:p-10">
                        ...
                        {activeTab === 'manuals' && (
                            <div className="space-y-4">
                                {/* Encabezado */}
                                <div className={`bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl ${isMobile ? 'p-3' : 'p-6 sm:p-8'}`}>
                                    <div className={`flex items-center ${isMobile ? 'gap-2 mb-4' : 'gap-3 mb-6'}`}>
                                        <div className={`${isMobile ? 'w-8 h-8' : 'w-10 h-10'} bg-gray-900 rounded-xl flex items-center justify-center flex-shrink-0`}>
                                            <svg className={`${isMobile ? 'w-4 h-4' : 'w-5 h-5'} text-white`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                            </svg>
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <h2 className={`${isMobile ? 'text-sm font-bold' : 'text-xl sm:text-2xl font-bold'} text-gray-900 leading-tight`}>
                                                {isMobile ? 'Manuales' : 'Manuales del Sistema'}
                                            </h2>
                                            <p className={`${isMobile ? 'text-[10px] mt-0.5' : 'text-sm mt-1'} text-gray-600 line-clamp-1`}>
                                                {isMobile ? 'Guías de uso' : 'Documentación y guías de uso del sistema'}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className={isMobile ? 'space-y-2' : 'space-y-3'}>
                                        {availableManuals.map((manual, index) => (
                                            <div
                                                key={index}
                                                className={`bg-white border-2 border-gray-200 rounded-xl ${isMobile ? 'p-2.5' : 'p-4'} hover:border-gray-400 transition-all`}
                                            >
                                                {isMobile ? (
                                                    // Layout vertical compacto para móviles
                                                    <div className="space-y-2">
                                                        <div className="flex items-start gap-2">
                                                            {/* Icono PDF más pequeño */}
                                                        ...
                                                        <div className="flex gap-2">
                                                            <button
                                                                ...
                                                                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-600 hover:text-white transition-all text-xs font-semibold"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-900 hover:text-white transition-all text-xs font-semibold"
                                                            >
                                                                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            <button
                                                                onClick={() => handleViewManual(manual.file)}
                                                                className="p-2.5 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-600 hover:text-white transition-all"
                                                                title="Ver"
                                                            >
                                                            ...
                                                            <button
                                                                onClick={() => handleDownloadManual(manual.file, manual.name)}
                                                                className="p-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-900 hover:text-white transition-all"
                                                                title="Descargar"
                                                            >
                                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
