...
export const VisitRegistrationSidePanel: React.FC<VisitRegistrationSidePanelProps> = ({
  ...
  return (
    <>
      ...
      {/* Modal de Alerta de Datos QR Cargados */}
      {qrDataAlert?.show && (
            ...
            <div className="relative p-8 rounded-t-2xl bg-gradient-to-br from-gray-900 to-gray-700">
              ...
              <div className="relative flex items-start justify-between text-white">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold text-white">Datos del QR cargados</h3>
                    <p className="text-sm text-white/80 mt-1">Evento: {qrDataAlert.eventName}</p>
                  </div>
                </div>
                <button
