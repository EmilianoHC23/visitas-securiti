          ...
          <nav className="flex -mb-px">
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <MdEvent className={`${isMobile ? 'w-3.5 h-3.5' : 'w-4 h-4'}`} />
                <span>Activos</span>
              </div>
            </button>
            <button
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <MdEventAvailable className={`${isMobile ? 'w-3.5 h-3.5' : 'w-4 h-4'}`} />
        ...
        <div className={`${isMobile ? 'p-3' : 'p-6'} space-y-4`}>
          ...
          {loading ? (
            ...
            <div className={`text-center ${isMobile ? 'py-12' : 'py-16'} bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 ${isMobile ? 'mx-0 mb-0' : 'mx-6 mb-6'}`}>
              <MdEventBusy className={`${isMobile ? 'w-12 h-12' : 'w-16 h-16'} text-gray-400 mx-auto mb-4`} />
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-gray-900 to-gray-700 rounded-xl flex items-center justify-center mr-2 sm:mr-3 shadow-md flex-shrink-0">
                  <InfoAccesoIcon className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                </div>
